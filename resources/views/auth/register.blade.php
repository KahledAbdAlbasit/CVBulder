    ...
    <head>
        ...
        <!-- Fonts CSS -->
        <link href="{{asset('backend/https://fonts.googleapis.com/css2?family=Overpass:ital,wght@0,100;0,200;0,300;0,400;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap')}}" rel="stylesheet">
        <!-- Icons CSS -->
    ...
    <body class="light ">
        ...
        <div class="row align-items-center h-100">
            ...
            <div class="form-group">
                ...
                <input type="email" id="inputEmail" class="form-control form-control-lg" name="email" :value="old('email')" placeholder="Email address" required=""
                autofocus="">
                <x-input-error :messages="$errors->get('email')" class="mt-2" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" id="inputPassword" class="form-control form-control-lg" name="password_confirmation" placeholder="Confirm Password" required="">
